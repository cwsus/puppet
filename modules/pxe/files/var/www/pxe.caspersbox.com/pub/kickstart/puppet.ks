...
user --uid=5002 --groups=puppet,sudoers         --name=puppet --password=$6$1syGXvDD0OhrLAiQ$y0lpuOXCnFNpz1xh6QAfUUHKtZSjmdQNSO8JGvCgfu6xLFjBLK1clANBzqy0GuGmYTm.Awby4SV17BfSTM8dz/ --iscrypted
...
#
part pv.01 --fstype="lvmpv" --ondisk=sda --size=14340
...
logvol /etc/puppetlabs --fstype="ext4" --size=512  --vgname=centos --name=lv_etc-puppetlabs --label=lv_etc-puppetlabs --mkfsoptions="-m 1" --fsoptions="rw,nodev,noexec,nosuid"
...
logvol /var/www        --fstype="ext4" --size=512  --vgname=centos --name=lv_var-www        --label=lv_var-www        --mkfsoptions="-m 1" --fsoptions="rw,nodev,noexec,nosuid"
