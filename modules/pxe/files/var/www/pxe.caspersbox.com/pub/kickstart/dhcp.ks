...
user --uid=5001 --groups=webgrp,sudoers         --name=dhcpd  --password=$6$ZH2GlxmxqcOrdkhf$Y0FeKwXNKQH.IkTdMG9r0gTfMT0S07T5sgPo5omdGPUFwVa4fZ/ykX.CofAld4DuqTCOH9CyMY543UxNUoc06/ --iscrypted
...
logvol /var/lib/dhcpd --fstype="ext4"  --size=256  --vgname=centos --name=lv_var-dhcpd --label=lv_var-dhcpd --mkfsoptions="-m 1" --fsoptions="rw,nodev,noexec,nosuid"
